...
public class Contest1
{
	...
	public static int getStepCount(int input1, int input2, int input3, int input4){
		...
		if(input1+2<=8 && input2+1<=8 && input3>input1+1 && input4>input2 && !set.contains((input1+2)+","+(input2+1)) && !end){
			System.out.println("Inside 1");
			getStepCount(input1+2, input2+1, input3, input4);
		}
		if(input1+2<=8 && input2-1>=1 && input3>input1+1 && input4<=input2  && !set.contains((input1+2)+","+(input2-1)) && !end){
